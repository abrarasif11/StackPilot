    ...
    <div className="w-full min-h-screen bg-[#F3F6FB] py-10 px-6">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white  rounded-xl shadow-sm p-6">
          ...
          <button
            type="button"
            className="w-full bg-gradient-to-r from-green-400 to-green-600 text-white py-3 rounded-lg text-sm font-medium flex items-center justify-center gap-2 cursor-pointer"
        ...
        <div className="bg-white  rounded-xl shadow-sm p-6">
          ...
          <div className="flex-1 min-h-[220px] flex items-center justify-center">
            <div className="text-center">
              ...
              <p className="text-gray-500 text-sm mt-3 max-w-[340px]">
